/**
 * Dekorations-Helferfunktionen für den StartScreen:
 * Hintergrund, Titel-Banner und Vignette.
 */
...
/**
 * Zeichnet den Himmels-Verlauf und die Wald-Hintergrundebenen.
 *
...
/**
 * Zeichnet den verzierten Rahmen hinter dem Spieltitel.
 *
 * @param {CanvasRenderingContext2D} ctx
 * @param {number} cx      - Horizontaler Mittelpunkt der Leinwand
 * @param {number} titleY  - Y-Position des Titelschriftzugs
 */
...
/**
 * Zeichnet eine dunkle radiale Randabdunklung über die gesamte Leinwand.
 *
 * @param {CanvasRenderingContext2D} ctx
 * @param {number} cx  - Horizontaler Mittelpunkt
 * @param {number} cy  - Vertikaler Mittelpunkt
 */
